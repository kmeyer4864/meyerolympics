...
export const puzzles: FlashbackPuzzle[] = [
  ...
  {
    id: 'puzzle-ancient-world',
    theme: 'Ancient World',
    events: [
      { id: 'e1', description: 'The Great Pyramid of Giza was completed', year: -2560 },
      { id: 'e2', description: 'Hammurabi\'s Code was inscribed into law in Babylon', year: -1754 },
      { id: 'e3', description: 'The Trojan War ended with the fall of Troy', year: -1184 },
      { id: 'e4', description: 'The city of Rome was founded', year: -753 },
      { id: 'e5', description: 'The Buddha attained enlightenment under the Bodhi tree', year: -528 },
      { id: 'e6', description: 'Socrates was sentenced to death in Athens', year: -399 },
      { id: 'e7', description: 'Alexander the Great conquered the Persian Empire', year: -330 },
      { id: 'e8', description: 'Julius Caesar was assassinated in the Roman Senate', year: -44 },
      { id: 'e9', description: 'The Colosseum in Rome was completed and inaugurated', year: 80 },
    ],
  },
  {
    id: 'puzzle-inventions',
    theme: 'Inventions That Changed the World',
    events: [
      { id: 'e1', description: 'Gutenberg printed the first Bible using movable type', year: 1455 },
      { id: 'e2', description: 'Galileo Galilei first used a telescope to observe the night sky', year: 1609 },
      { id: 'e3', description: 'James Watt patented an improved steam engine with a separate condenser', year: 1769 },
      { id: 'e4', description: 'Samuel Morse demonstrated the telegraph by sending a message between Washington and Baltimore', year: 1844 },
      { id: 'e5', description: 'Alexander Graham Bell made the first successful telephone call', year: 1876 },
      { id: 'e6', description: 'The Wright Brothers completed the first powered airplane flight at Kitty Hawk', year: 1903 },
      { id: 'e7', description: 'Penicillin was accidentally discovered by Alexander Fleming', year: 1928 },
      { id: 'e8', description: 'The first commercial nuclear power plant began generating electricity in the United States', year: 1958 },
      { id: 'e9', description: 'Tim Berners-Lee published his proposal for the World Wide Web', year: 1989 },
    ],
  },
  {
    id: 'puzzle-women-history',
    theme: 'Women in History',
    events: [
      { id: 'e1', description: 'Joan of Arc led the French army to lift the Siege of Orléans', year: 1429 },
      { id: 'e2', description: 'Queen Elizabeth I was crowned Queen of England', year: 1558 },
      { id: 'e3', description: 'Mary Wollstonecraft published A Vindication of the Rights of Woman', year: 1792 },
      { id: 'e4', description: 'Harriet Tubman escaped slavery and began leading others to freedom via the Underground Railroad', year: 1849 },
      { id: 'e5', description: 'Marie Curie became the first woman to win a Nobel Prize', year: 1903 },
      { id: 'e6', description: 'Women in the United States gained the constitutional right to vote', year: 1920 },
      { id: 'e7', description: 'Sirimavo Bandaranaike became the world\'s first female prime minister', year: 1960 },
      { id: 'e8', description: 'Valentina Tereshkova became the first woman to travel to space', year: 1963 },
      { id: 'e9', description: 'Malala Yousafzai became the youngest person ever to receive the Nobel Peace Prize', year: 2014 },
    ],
  },
  {
    id: 'puzzle-scientific-breakthroughs',
    theme: 'Scientific Breakthroughs',
    events: [
      { id: 'e1', description: 'Nicolaus Copernicus published his heliocentric model of the solar system', year: 1543 },
      { id: 'e2', description: 'Isaac Newton published his laws of motion and universal gravitation', year: 1687 },
      { id: 'e3', description: 'Charles Darwin published On the Origin of Species', year: 1859 },
      { id: 'e4', description: 'Wilhelm Röntgen discovered X-rays', year: 1895 },
      { id: 'e5', description: 'Albert Einstein published his general theory of relativity', year: 1915 },
      { id: 'e6', description: 'The structure of DNA was described by Watson and Crick', year: 1953 },
      { id: 'e7', description: 'The first successful heart transplant was performed by Christiaan Barnard', year: 1967 },
      { id: 'e8', description: 'The Hubble Space Telescope was launched into orbit', year: 1990 },
      { id: 'e9', description: 'Scientists at CERN confirmed the discovery of the Higgs boson', year: 2012 },
    ],
  },
  {
    id: 'puzzle-cold-war',
    theme: 'Cold War Era',
    events: [
      { id: 'e1', description: 'The United States dropped atomic bombs on Hiroshima and Nagasaki', year: 1945 },
      { id: 'e2', description: 'The Korean War armistice was signed, ending active combat', year: 1953 },
      { id: 'e3', description: 'Sputnik 1 became the first artificial satellite to orbit Earth', year: 1957 },
      { id: 'e4', description: 'The Berlin Wall was erected, dividing East and West Berlin overnight', year: 1961 },
      { id: 'e5', description: 'The Cuban Missile Crisis brought the US and USSR to the brink of nuclear war', year: 1962 },
      { id: 'e6', description: 'The United States withdrew the last combat troops from Vietnam', year: 1973 },
      { id: 'e7', description: 'The Soviet Union invaded Afghanistan', year: 1979 },
      { id: 'e8', description: 'The Berlin Wall fell, reuniting East and West Germany', year: 1989 },
      { id: 'e9', description: 'The Soviet Union was formally dissolved, ending the Cold War', year: 1991 },
    ],
  },
]
